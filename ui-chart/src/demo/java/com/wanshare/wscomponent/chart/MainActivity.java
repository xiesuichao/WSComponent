...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment[] fragments = {DepthChartDemoFragment.newInstance(), TimeLineChartFragment.newInstance(1), FiveDayChartFragment.newInstance(),
                KLineChartFragment.newInstance(1), KLineChartFragment.newInstance(7),
                KLineChartFragment.newInstance(30)};
        String[] titles = {"深度图","分时图", "5Day", "日K", "周K", "月"};
