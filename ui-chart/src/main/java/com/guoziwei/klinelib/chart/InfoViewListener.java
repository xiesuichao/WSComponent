...
public class InfoViewListener implements OnChartValueSelectedListener {
    ...
    private WSKlineView mKlineChart;
    ...
    public InfoViewListener(Context context, double lastClose, List<HisData> list, ChartInfoView infoView, WSKlineView chart, Chart... otherChart) {
        mWidth = DisplayUtils.getWidthHeight(context)[0];
        mLastClose = lastClose;
        mList = list;
        mInfoView = infoView;
        this.mKlineChart=chart;
        mOtherChart = otherChart;
    }
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        if (x < mList.size()) {
            ...
            if(mKlineChart!=null){
                mKlineChart.setChartDescription(mList.get(x));
            }
        }
