...
public class TimeLineView extends BaseView implements CoupleChartGestureListener.OnAxisChangeListener {
    ...
    public TimeLineView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mChartPrice.setNoDataText(context.getString(R.string.chart_loading));
        initChartPrice();
...
//        leftColorContentYAxisRenderer.setUseDefaultLabelXOffset(true);
...
//        rightColorContentYAxisRenderer.setLabelInContent(false);
...
//        mChartPrice.moveViewToX(combinedData.getEntryCount());
    ...
    private BarDataSet setBar(ArrayList<BarEntry> barEntries, int type) {
        ...
        barDataSet.setHighLightColor(getResources().getColor(R.color.chart_highlight_color));
...
//        mChartPrice.setRealCount(mData.size());
        ...
        volSet.addEntry(new BarEntry(volSet.getEntryCount(), (float) hisData.getVol(), hisData));
