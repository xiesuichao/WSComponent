...
import com.wanshare.wscomponent.gfw.R;
import com.wanshare.wscomponent.gfw.core.ProxyConfig.IPAddress;
import com.wanshare.wscomponent.gfw.dns.DnsPacket;
import com.wanshare.wscomponent.gfw.tcpip.CommonMethods;
import com.wanshare.wscomponent.gfw.tcpip.IPHeader;
import com.wanshare.wscomponent.gfw.tcpip.TCPHeader;
import com.wanshare.wscomponent.gfw.tcpip.UDPHeader;
...
public class LocalVpnService extends VpnService implements Runnable {
    ...
    public synchronized void run() {
        try {
            ...
            ChinaIpMaskManager.loadFromFile(getApplicationContext().getResources().openRawResource(R.raw.ipmask));//加载中国的IP段，用于IP分流。
            waitUntilPreapred();//检查是否准备完毕。

            try {
                ProxyConfig.Instance.loadFromFile(getApplicationContext().getResources().openRawResource(R.raw.config));
            } catch (Exception e) {
            }
