...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Context context){
        ...
        mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.album_folder_cover_size);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if(view == null){
            view = mInflater.inflate(R.layout.album_item_folder, viewGroup, false);
        ...
        if (holder != null) {
            if(i == 0){
                holder.name.setText(mContext.getResources().getString(R.string.album_all_image));
