 ...
 * </br>
 */
public class AroundProgressBar extends View implements Runnable{
    ...
    public AroundProgressBar(Context context) {
        this(context, null, 0);
    }

    public AroundProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AroundProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(attrs);
    }

    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.AroundProgressBar);
        try {
            textSize = (int) ta.getDimension(R.styleable.AroundProgressBar_textSize, 12);
            loadingColor = ta.getColor(R.styleable.AroundProgressBar_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.AroundProgressBar_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.AroundProgressBar_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.AroundProgressBar_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
