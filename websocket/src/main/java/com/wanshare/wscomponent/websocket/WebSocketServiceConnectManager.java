...
public class WebSocketServiceConnectManager {
    ...
    public void sendText(String text) {
        Log.d(TAG,"websocket sendText:"+text+" mWebSocketService:"+mWebSocketService+" webSocketServiceBindSuccess:"+webSocketServiceBindSuccess);
        if (webSocketServiceBindSuccess && mWebSocketService != null) {
            mWebSocketService.sendText(text);
        } else {
            ErrorResponse errorResponse = new ErrorResponse();
            errorResponse.setErrorCode(MessageType.SERVICE_BIND_ERROR);
