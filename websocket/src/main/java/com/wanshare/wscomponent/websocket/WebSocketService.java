...
//        mHeartbeatThread = new HeartbeatThread();
    ...
    public void onConnected() {
        Log.d("WebSocketService", "WebSocket onConnected");
        responseDispatcher.onConnected(mResponseDelivery);
//        mHeartbeatThread.setWebSocketClient(mWebSocketThread.getSocket());
//        mHeartbeatThread.start();
    ...
    public void onDisconnected() {
        Log.d("WebSocketService", "WebSocket onDisconnected");
